    ...
    <UrlSubmitForm page="search">
      <div class="col-auto">
        <input name="street" type="text" class="form-control form-control-sm me-1"
               placeholder="Número exterior/Calle"
...
<details id="searchAdvancedOptions">
  <summary><small>Opciones avanzadas</small></summary>
  <ul>
    <li>
      <div class="form-check form-check-inline">
        <label class="form-check-label" for="use_viewbox">aplicar a la vista</label>
    ...
    <li>
      <div class="form-check form-check-inline">
        <label class="form-check-label" for="option_bounded">limitado a la vista</label>
        <input type="checkbox" class="form-check-input api-param-setting"
    ...
    <li>
      <div class="form-check form-check-inline">
        <label class="form-check-label" for="option_dedupe">eliminar duplicados</label>
        <input type="checkbox"
    ...
    <li>
      <label for="option_limit">número máximo de resultados</label>
      <input type="number"
    ...
    <li>
      <label for="option_polygon_threshold">simplificación de polígonos</label>
      <input type="number"
             class="form-control form-control-sm d-inline w-auto api-param-setting"
    ...
    <li>
      <label for="accept_lang">lenguajes</label>
      <input type="text" placeholder="ej. en, zh-Hant"
             class="form-control form-control-sm d-inline w-auto api-param-setting"
    ...
    <li>
      <label for="option_ccode">código de país</label>
      <input type="text" placeholder="ej. de, gb"
            class="form-control form-control-sm d-inline w-auto api-param-setting"
    ...
    <li>
      <label for="option_layer">capa OSM</label>
      <input id="option_layer" name="layer" placeholder="ej. address, poi, railway, natural, manmade"
